...
import { Server, Database, Shield, Wifi, HardDrive, Cpu, CheckCircle, AlertTriangle, Settings } from "lucide-react"
...
export default function SystemGrid({ systems, onSelectSystem }: SystemGridProps) {
